[file name]: views/certificates.blade.php
[file content begin]
@extends('layouts.app')

@section('title', 'Сертификаты - Токус Bloom')
            ...
            <div class="container">
                <div class="about-content">
                    ...
                    <div class="about-image">
                        <img src="{{ asset('./src/images/Rectangle 40.png') }}" alt="Подарочные сертификаты" 
                             onerror="this.style.display='none'; this.parentNode.innerHTML='<div class=image-placeholder>Здесь будет изображение сертификата</div>';">
                    </div>
                </div>
            </div>
        </section>
